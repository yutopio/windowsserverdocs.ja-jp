...
3. [古いログオン スクリプトを削除する (オプション)](#remove-old-logon-scripts)

4. [レガシ Active Directory グループ ポリシー オブジェクトを削除する (オプション)](#remove-legacy-active-directory-group-policy-objects)
