...
-   [IDomainSignupProvider インターフェイスの実装のアセンブリへの追加](Add-Third-Level-Domain-Names.md#BKMK_DomainSignup)

-   [IDomainMaintenanceProvider インターフェイスの実装のアセンブリへの追加](Add-Third-Level-Domain-Names.md#BKMK_DomainMaintenance)

-   [Authenticode 署名を使用してアセンブリに署名する](Add-Third-Level-Domain-Names.md#BKMK_SignAssembly)

-   [アセンブリの参照コンピューターへのインストール](Add-Third-Level-Domain-Names.md#BKMK_InstallAssembly)
