...
- [Windows Server Essentials ダッシュボードへのアクセス](#BKMK_AccessDb)

- [セーフ モードの使用](#BKMK_UseSafeMode)
...
|3|[タスク] ウィンドウ|このウィンドウには、選択したカテゴリに適用されるタスクと情報へのリンクが表示されます。 タスクまたはリソースをクリックし、追加情報を表示します。|
...
|ユーザー|ユーザーが Windows Server Essentials が提供するリソースにアクセスするには、Windows Server Essentials ダッシュボードを使用してユーザー アカウントを作成する必要があります。 ユーザー アカウントを作成すると、ダッシュボードの [**ユーザー**] ページで利用可能なタスクを使用してアカウントを管理できます。 このページで実行できるタスクは、次のとおりです。<br /><br /> -ユーザーアカウントの一覧を表示します。<br /><br /> -ユーザーアカウントのプロパティを表示および管理します。<br /><br /> -ユーザーアカウントをアクティブ化または非アクティブ化します。<br /><br /> -ユーザーアカウントを追加または削除します。<br /><br /> -サーバーが Microsoft 365 と統合されている場合は、ローカルネットワークアカウントを Microsoft オンラインサービスアカウントに割り当てます。<br /><br /> -ユーザーアカウントのパスワードを変更し、パスワードポリシーを管理します。<br /><br /> ユーザーアカウントの管理の詳細については、「 [ユーザーアカウントの管理](Manage-User-Accounts-in-Windows-Server-Essentials.md)」を参照してください。|
