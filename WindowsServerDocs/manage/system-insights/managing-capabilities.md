...
このセクションでは PowerShell の例を紹介しますが、system [Insights powershell のドキュメント](/powershell/module/systeminsights/) を使用して、system insights 内のすべてのコマンドレット、パラメーター、パラメーターセットを確認できます。
