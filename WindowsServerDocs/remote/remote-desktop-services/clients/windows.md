...
ms.locfileid: "90779256"
---
# <a name="get-started-with-the-microsoft-store-client"></a>Microsoft Store クライアントの概要

>適用先:Windows 10

Windows 用のリモート デスクトップ クライアントを使用して、別の Windows デバイスからリモートで、Windows アプリと PC を使用することができます。
...
### <a name="add-a-remote-pc-connection"></a>リモート PC 接続を追加する
...
### <a name="pin-a-saved-pc-to-your-start-menu"></a>保存した PC を [スタート] メニューにピン留めする
...
## <a name="navigate-your-remote-session"></a>リモート セッション内を移動する

ここでは、サービスに接続した後にリモート セッション内を移動するために使用できるツールについて説明します。

### <a name="start-a-remote-session"></a>リモート セッションを開始する
...
### <a name="use-direct-touch-gestures-and-mouse-modes"></a>直接タッチ ジェスチャとマウス モードを使用する
