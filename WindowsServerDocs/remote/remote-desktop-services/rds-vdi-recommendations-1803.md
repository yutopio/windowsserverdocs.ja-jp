...
単一のイメージに基づく非永続的 VDI の重要な側面の 1 つに、サービスがあります。 オペレーティング システムの更新は、通常は月に 1 回配信されます。
...
詳細については、[Windows PowerShell フォーラム](/answers/topics/windows-server-powershell.ht)をご確認ください。
