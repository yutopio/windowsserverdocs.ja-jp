...
ms.openlocfilehash: a41855323fcffaf0958b6caff19bd39eb887c93b
ms.sourcegitcommit: d08965d64f4a40ac20bc81b14f2d2ea89c48c5c8
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 12/08/2020
ms.locfileid: "96866361"
---
...
クラスター化された役割を追加する方法の例については、「 [Add-ClusterFileServerRole](/powershell/module/failoverclusters/add-clusterfileserverrole) 」や「 [Add-ClusterGenericApplicationRole](/powershell/module/failoverclusters/add-clustergenericapplicationrole)」などのトピックを参照してください。

AD のデタッチされたフェールオーバークラスターが作成された後、秘密キーがエクスポート可能な証明書をバックアップするオプション。 MMC を開く = =>ファイル = =>追加削除スナップイン = =>Certificates = =>Services Accounts = =>次の = =>ローカルコンピューター = =>クラスターサービス = =>証明書 = =>Clussvc\Personal = =>証明書を右クリックする = =>export = =>Next = =>はい、秘密キーをエクスポートする = =>PfX 形式 = =>パスワードを選択します。または、group = =>Next = =>を追加することができます。 「内部記事に詳細が記載されています。 https://internal.support.services.microsoft.com/en-US/help/4569891 」
