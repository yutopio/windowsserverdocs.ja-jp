...
Windows Server バージョン1709の **テストフェールオーバー** コマンドレット Debuted も windows server 2019 に含まれています。 これにより、バックアップやテストなどの目的で、宛先ボリュームの読み取り/書き込みスナップショットを一時的にマウントできるようになりました。詳細については、「」を参照してください https://aka.ms/srfaq 。
