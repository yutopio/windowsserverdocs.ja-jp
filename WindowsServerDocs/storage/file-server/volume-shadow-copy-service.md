...
VSS では、バックアップするデータの一貫したシャドウ コピー (スナップショットまたは特定の時点のコピーとも呼ばれます) を作成するために必要なアクションが調整されます。 シャドウ コピーはそのまま使用することも、次のようなシナリオで使用することもできます。
  ...
  - 元の論理ユニット番号 (LUN: Logical Unit Number) にデータを復元するか、障害が発生した元の LUN を置き換える完全に新しい LUN にデータを復元することにより、データ損失から迅速に回復する必要がある。
...
**図 3**   シャドウ コピーの作成と 2 つのサーバー間での転送
...
### <a name="i-made-a-backup-on-windows-server-2008-can-i-restore-it-on-windows-server-2008-r2"></a>Windows Server 2008 でバックアップを作成しました。 Windows Server 2008 R2 で復元することはできますか?
...
### <a name="i-made-a-backup-on-windows-server-2003-can-i-restore-it-on-windows-server-2008"></a>Windows Server 2003 でバックアップを作成しました。 Windows Server 2008 で復元することはできますか?
