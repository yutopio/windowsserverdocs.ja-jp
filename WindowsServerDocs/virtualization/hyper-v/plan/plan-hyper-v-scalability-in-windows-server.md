...
> [!NOTE]
> System Center Virtual Machine Manager (VMM) についての情報を参照してください。 [Virtual Machine Manager](/system-center/vmm/overview)します。 VMM は仮想データ センターを管理するためのマイクロソフト製品であり、別途購入する必要があります。
