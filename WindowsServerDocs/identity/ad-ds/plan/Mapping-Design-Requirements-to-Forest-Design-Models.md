...
|[シナリオ 3: サービスの分離に組織のフォレストまたはリソースフォレストを使用する](#BKMK_3)|いいえ|いいえ|N/A|はい|該当なし|
|[シナリオ 4: データの分離に組織フォレストまたは制限付きアクセスフォレストを使用する](#BKMK_4)|N/A|はい|該当なし|N/A|N/A|
...
|[シナリオ 7: リソースフォレストを使用し、接続が制限されたサービスの分離のためにファイアウォールを再構成する](#BKMK_7)|はい|いいえ|N/A|はい|該当なし|
