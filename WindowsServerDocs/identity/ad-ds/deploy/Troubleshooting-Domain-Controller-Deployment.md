...
| 解決策と説明 | 作成済みの RODC アカウント上で既に定義済みのパラメーターを指定しないでください。 次に例を示します。<p>Code--readonlyreplica<br />-installdns<br />-donotconfigureglobalcatalog<br />-sitename<br />-installdns |
