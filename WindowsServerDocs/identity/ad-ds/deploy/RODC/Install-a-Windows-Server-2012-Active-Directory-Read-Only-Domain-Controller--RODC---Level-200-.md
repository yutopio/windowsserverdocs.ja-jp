...
| ADDSDeployment コマンドレット | 引数 ( **太字** の引数が必要です。 *斜体* の引数は、Windows PowerShell または AD DS 構成ウィザードを使用して指定できます。) |
|--|--|
| Install-AddsDomainController | -SkipPreChecks<p>***-DomainName * *_<p>_ -* <p>*****_<p>_ ApplicationPartitionsToReplicate *<p>* -creatednsdelegation * <p> * * *-Credential** _<p>_ *<p>* *<p>* *<p> <p>* -CriticalReplicationOnly-databasepath-DNSDelegationCredential-InstallationMediaPath--LogPath のように入力します。 *<p>* *<p>* *<p> -moveNoGlobalCatalog <p>**<p> Norebootoncompletion <p>* -SkipAutoConfigureDNS- *<p> <p>* -SYSVOLPath- *<p>* *<p>* allowpasswordreplicationaccountname *<p>* -DelegatedAdministratorAccountName *<p>* ----------<p>***-ReadOnlyReplica** _ |
