...
- [ドメイン アクセスを計画する](#bkmk_NetFndtn_Pln_DomAccess)
...
### <a name="planning-domain-access"></a><a name="bkmk_NetFndtn_Pln_DomAccess"></a>ドメイン アクセスを計画する
...
- [NPS1 を展開する](#BKMK_deployNPS1)

- [WEB1 を展開する](#BKMK_IIS)

#### <a name="deploying-nps1"></a><a name="BKMK_deployNPS1"></a>NPS1 を展開する
...
- Windows Server 2016、Windows Server 2012 R2、Windows Server 2012、Windows Server 2008 R2、Windows Server 2008、ルーティングとリモートアクセスサービス、ターミナルサービスゲートウェイ、リモートデスクトップゲートウェイを実行しているコンピューターなど、RADIUS プロトコルと互換性のあるリモートアクセスサーバーを含めるようにネットワークを拡張することを計画しています。
...
- [NPS1 の展開を計画する](#bkmk_NetFndtn_Pln_NPS-01)

- [ネットワーク ポリシー サーバー (NPS) をインストールする](#BKMK_installNPS)
...
##### <a name="planning-the-deployment-of-nps1"></a><a name="bkmk_NetFndtn_Pln_NPS-01"></a>NPS1 の展開を計画する
...
- ユーザー アカウント データベースを計画します。 既定では、NPS を実行するサーバーを Active Directory ドメインに追加する場合、NPS では認証および承認が AD DS ユーザー アカウント データベースを使用して行われます。 NPS を RADIUS プロキシとして使用して他の RADIUS サーバーへの接続要求を転送する、大規模ネットワークなどの一部の環境では、NPS を非ドメイン メンバー コンピューター上にインストールする場合があります。
...
##### <a name="install-network-policy-server-nps"></a><a name="BKMK_installNPS"></a>ネットワーク ポリシー サーバー (NPS) をインストールする
...
#### <a name="deploying-web1"></a><a name="BKMK_IIS"></a>WEB1 を展開する
...
- [Web サーバー (IIS) サーバー役割をインストールする](#BKMK_install_IIS)

##### <a name="install-the-web-server-iis-server-role"></a><a name="BKMK_install_IIS"></a>Web サーバー (IIS) サーバー役割をインストールする
...
## <a name="additional-technical-resources"></a><a name="BKMK_resources"></a>その他の技術情報
...
1.  [付録 A - コンピューターの名前を変更する](#BKMK_A)

2.  [付録 B - 静的 IP アドレスを構成する](#BKMK_B)
...
## <a name="appendix-a---renaming-computers"></a><a name="BKMK_A"></a>付録 A - コンピューターの名前を変更する
...
- [Windows Server 2008 と Windows Vista](#bkmk_NetFndtn_Pln_Renam08)
...
1.  [**スタート**] をクリックし、[**コンピューター**] を右クリックして、[**プロパティ**] をクリックします。 **[システム]** ダイアログ ボックスが開きます。
...
### <a name="windows-server-2008-and-windows-vista"></a><a name="bkmk_NetFndtn_Pln_Renam08"></a>Windows Server 2008 と Windows Vista
これらの手順を実行するには、**Administrators** のメンバーシップ、またはそれと同等のメンバーシップが最低限必要です。

##### <a name="to-rename-computers-running-windows-server-2008-and-windows-vista"></a>Windows Server 2008 および Windows Vista を実行するコンピューター名を変更するには
...
## <a name="appendix-b---configuring-static-ip-addresses"></a><a name="BKMK_B"></a>付録 B - 静的 IP アドレスを構成する
...
- [Windows Server 2008 と Windows Vista](#BKMK_c2)
...
##### <a name="to-join-computers-running-windows-server-2008-r2-and-windows-7-to-the-domain"></a>Windows Server 2008 R2 および Windows 7 を実行するコンピューターをドメインに追加するには

1.  ローカルの Administrator アカウントでコンピューターにログオンします。

2.  [**スタート**] をクリックし、[**コンピューター**] を右クリックして、[**プロパティ**] をクリックします。 **[システム]** ダイアログ ボックスが開きます。
...
### <a name="windows-server-2008-and-windows-vista"></a><a name="BKMK_c2"></a>Windows Server 2008 と Windows Vista
この手順を実行するには、**Domain Users**、またはそれと同等のメンバーシップが最低限必要です。

##### <a name="to-join-computers-running-windows-server-2008-and-windows-vista-to-the-domain"></a>Windows Server 2008 および Windows Vista を実行するコンピューターをドメインに追加するには
...
- [Windows Server 2008 と Windows Vista](#BKMK_d2)

### <a name="windows-server-2008-r2-and-windows-7"></a><a name="BKMK_d1"></a>Windows Server 2008 R2 および Windows 7
この手順を実行するには、**Domain Users**、またはそれと同等のメンバーシップが最低限必要です。

##### <a name="log-on-to-the-domain-using-computers-running-windows-server-2008-r2-and-windows-7"></a>Windows Server 2008 R2 および Windows 7 を実行するコンピューターを使用してドメインにログオンする
...
### <a name="windows-server-2008-and-windows-vista"></a><a name="BKMK_d2"></a>Windows Server 2008 と Windows Vista
この手順を実行するには、**Domain Users**、またはそれと同等のメンバーシップが最低限必要です。

##### <a name="log-on-to-the-domain-using-computers-running-windows-server-2008-and-windows-vista"></a>Windows Server 2008 および Windows Vista を実行するコンピューターを使用してドメインにログオンする
...
## <a name="appendix-e---core-network-planning-preparation-sheet"></a><a name="BKMK_E"></a>付録 E - コア ネットワークの計画準備シート
...
1.  [Active Directory Domain Services と DNS をインストールする](#BKMK_FndtnPrep_InstallAD)

    - [DNS 逆引き参照ゾーンを構成する](#BKMK_FndtnPrep_DNSRevrsLook)

2.  [DHCP をインストールする](#BKMK_FndtnPrep_InstallDHCP)

    - [DHCP に除外範囲を作成する](#BKMK_FndtnPrep_DHCP_Exclusn)

    - [新しい DHCP スコープを作成する](#bkmk_NetFndtn_Pln_DHCP_NewScope)

3.  [ネットワーク ポリシー サーバーをインストールする (オプション)](#BKMK_FndtnPrep_InstallNPS)

### <a name="installing-active-directory-domain-services-and-dns"></a><a name="BKMK_FndtnPrep_InstallAD"></a>Active Directory Domain Services と DNS をインストールする
このセクションの表は、Active Directory Domain Services (AD DS) と DNS の事前インストールおよびインストールのための構成項目の一覧です。
...
##### <a name="ad-ds-and-dns-installation-configuration-items"></a>AD DS および DNS インストールの構成項目
...
#### <a name="configuring-a-dns-reverse-lookup-zone"></a><a name="BKMK_FndtnPrep_DNSRevrsLook"></a>DNS 逆引き参照ゾーンを構成する
...
### <a name="installing-dhcp"></a><a name="BKMK_FndtnPrep_InstallDHCP"></a>DHCP をインストールする
...
#### <a name="creating-an-exclusion-range-in-dhcp"></a><a name="BKMK_FndtnPrep_DHCP_Exclusn"></a>DHCP に除外範囲を作成する
...
#### <a name="creating-a-new-dhcp-scope"></a><a name="bkmk_NetFndtn_Pln_DHCP_NewScope"></a>新しい DHCP スコープを作成する
...
|リース期間<p>日間<p>時間<p>分|-8<br />-0<br />-0||
|ルーター (デフォルト ゲートウェイ)<p>IP アドレス|10.0.1.1||
|DNS 親ドメイン|corp.contoso.com||
|DNS サーバー<p>IP アドレス|10.0.0.2||

### <a name="installing-network-policy-server-optional"></a><a name="BKMK_FndtnPrep_InstallNPS"></a>ネットワーク ポリシー サーバーをインストールする (オプション)
