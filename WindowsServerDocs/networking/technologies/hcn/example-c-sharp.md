---
title: 最上位の IPAM & サブネットオブジェクト用に生成された C# コードの例
description: 最上位の IPAM & サブネットオブジェクト用に生成された C# コードの例。
ms.author: daschott
author: daschott
ms.date: 11/05/2018
...
ms.locfileid: "90083713"
---
# <a name="example-of-c-generated-code"></a>C# で生成されたコードの例
